 ...
 *  Copyright (c) 2015-2020 ircd-hybrid development team
 *
 ...
 * \version $Id: tls.h 9223 2020-01-26 11:35:22Z michael $
 */
...
enum { TLS_HANDSHAKE_TIMEOUT = 5 };  /**< Time in seconds for the TLS handshake to time out */
