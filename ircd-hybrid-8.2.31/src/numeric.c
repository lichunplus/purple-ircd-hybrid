 ...
 * \version $Id: numeric.c 9349 2020-04-26 05:59:56Z michael $
 */
...
static const char *const replies[] =
{
  ...
  /* 211 */  [RPL_STATSLINKINFO] = "%s %u %u %ju %u %ju :%ju %ju %s",
  /* 212 */  [RPL_STATSCOMMANDS] = "%s %u %ju :%u",
  ...
  /* 227 */  [RPL_STATSPSEUDO] = "s %s %s %s@%s :%s",
  ...
  /* 317 */  [RPL_WHOISIDLE] = "%s %u %ju :seconds idle, signon time",
  ...
  /* 346 */  [RPL_INVEXLIST] = "%s %s %s %ju",
  /* 347 */  [RPL_ENDOFINVEXLIST] = "%s :End of Channel Invite List",
  /* 348 */  [RPL_EXCEPTLIST] = "%s %s %s %ju",
  ...
  /* 447 */  [ERR_NONICKCHANGE] = ":Cannot change nickname while on %s (+N)",
  ...
  /* 743 */  [ERR_INVALIDBAN] = "%s :Invalid ban mask",
